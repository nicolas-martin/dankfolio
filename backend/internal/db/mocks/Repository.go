...
// HardDelete provides a mock function for the type MockRepository
func (_mock *MockRepository[T]) HardDelete(ctx context.Context, id string) error {
	ret := _mock.Called(ctx, id)
...
// MockRepository_HardDelete_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'HardDelete'
type MockRepository_HardDelete_Call[T db.Entity] struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - id string
func (_e *MockRepository_Expecter[T]) HardDelete(ctx interface{}, id interface{}) *MockRepository_HardDelete_Call[T] {
	return &MockRepository_HardDelete_Call[T]{Call: _e.mock.On("HardDelete", ctx, id)}
}

func (_c *MockRepository_HardDelete_Call[T]) Run(run func(ctx context.Context, id string)) *MockRepository_HardDelete_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_HardDelete_Call[T]) Return(err error) *MockRepository_HardDelete_Call[T] {
	_c.Call.Return(err)
	return _c
}

func (_c *MockRepository_HardDelete_Call[T]) RunAndReturn(run func(ctx context.Context, id string) error) *MockRepository_HardDelete_Call[T] {
	_c.Call.Return(run)
	return _c
}
