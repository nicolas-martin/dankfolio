...
type MockRepository_Create_Call[T any] struct {
	*mock.Call
}
...
type MockRepository_Get_Call[T any] struct {
	*mock.Call
}
...
type MockRepository_List_Call[T any] struct {
	*mock.Call
}
...
type MockRepository_Upsert_Call[T any] struct {
	*mock.Call
}
