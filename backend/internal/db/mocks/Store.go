...
// Coins provides a mock function with no fields
func (_m *MockStore) Coins() db.Repository[model.Coin] {
	ret := _m.Called()
	...
	if rf, ok := ret.Get(0).(func() db.Repository[model.Coin]); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockStore_Coins_Call) Return(_a0 db.Repository[model.Coin]) *MockStore_Coins_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *MockStore) ListTrendingCoins(ctx context.Context) ([]model.Coin, error) {
	ret := _m.Called(ctx)
...
func (_c *MockStore_ListTrendingCoins_Call) Return(_a0 []model.Coin, _a1 error) *MockStore_ListTrendingCoins_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStore_ListTrendingCoins_Call) RunAndReturn(run func(context.Context) ([]model.Coin, error)) *MockStore_ListTrendingCoins_Call {
	_c.Call.Return(run)
	return _c
}

// RawCoins provides a mock function with no fields
func (_m *MockStore) RawCoins() db.Repository[model.RawCoin] {
	ret := _m.Called()
	...
	if rf, ok := ret.Get(0).(func() db.Repository[model.RawCoin]); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockStore_RawCoins_Call) Return(_a0 db.Repository[model.RawCoin]) *MockStore_RawCoins_Call {
	_c.Call.Return(_a0)
	return _c
}
...
// SearchCoins provides a mock function with given fields: ctx, query, tags, minVolume24h, limit, offset, sortBy, sortDesc
func (_m *MockStore) SearchCoins(ctx context.Context, query string, tags []string, minVolume24h float64, limit int32, offset int32, sortBy string, sortDesc bool) ([]model.Coin, error) {
	ret := _m.Called(ctx, query, tags, minVolume24h, limit, offset, sortBy, sortDesc)
	...
	var r0 []model.Coin
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, []string, float64, int32, int32, string, bool) ([]model.Coin, error)); ok {
		return rf(ctx, query, tags, minVolume24h, limit, offset, sortBy, sortDesc)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, []string, float64, int32, int32, string, bool) []model.Coin); ok {
		r0 = rf(ctx, query, tags, minVolume24h, limit, offset, sortBy, sortDesc)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.Coin)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, []string, float64, int32, int32, string, bool) error); ok {
		r1 = rf(ctx, query, tags, minVolume24h, limit, offset, sortBy, sortDesc)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockStore_SearchCoins_Call) Return(_a0 []model.Coin, _a1 error) *MockStore_SearchCoins_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStore_SearchCoins_Call) RunAndReturn(run func(context.Context, string, []string, float64, int32, int32, string, bool) ([]model.Coin, error)) *MockStore_SearchCoins_Call {
	_c.Call.Return(run)
	return _c
}

// Trades provides a mock function with no fields
func (_m *MockStore) Trades() db.Repository[model.Trade] {
	ret := _m.Called()
	...
	if rf, ok := ret.Get(0).(func() db.Repository[model.Trade]); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockStore_Trades_Call) Return(_a0 db.Repository[model.Trade]) *MockStore_Trades_Call {
	_c.Call.Return(_a0)
	return _c
}
...
// Wallet provides a mock function with no fields
func (_m *MockStore) Wallet() db.Repository[model.Wallet] {
	ret := _m.Called()
	...
	if rf, ok := ret.Get(0).(func() db.Repository[model.Wallet]); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockStore_Wallet_Call) Return(_a0 db.Repository[model.Wallet]) *MockStore_Wallet_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *MockStore) WithTransaction(ctx context.Context, fn func(db.Store) error) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, func(db.Store) error) error); ok {
		r0 = rf(ctx, fn)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockStore_WithTransaction_Call) Run(run func(ctx context.Context, fn func(db.Store) error)) *MockStore_WithTransaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(func(db.Store) error))
	})
	return _c
}

func (_c *MockStore_WithTransaction_Call) Return(_a0 error) *MockStore_WithTransaction_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockStore_WithTransaction_Call) RunAndReturn(run func(context.Context, func(db.Store) error) error) *MockStore_WithTransaction_Call {
	_c.Call.Return(run)
	return _c
}
