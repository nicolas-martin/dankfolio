...
// Search provides a mock function for the type MockClientAPI
func (_mock *MockClientAPI) Search(ctx context.Context, params birdeye.SearchParams) (*birdeye.SearchResponse, error) {
	ret := _mock.Called(ctx, params)
	...
	var r0 *birdeye.SearchResponse
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, birdeye.SearchParams) (*birdeye.SearchResponse, error)); ok {
		return returnFunc(ctx, params)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, birdeye.SearchParams) *birdeye.SearchResponse); ok {
		r0 = returnFunc(ctx, params)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*birdeye.SearchResponse)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, birdeye.SearchParams) error); ok {
		r1 = returnFunc(ctx, params)
	} else {
		r1 = ret.Error(1)
	}
...
// MockClientAPI_Search_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Search'
type MockClientAPI_Search_Call struct {
	*mock.Call
}
...
func (_e *MockClientAPI_Expecter) Search(ctx interface{}, params interface{}) *MockClientAPI_Search_Call {
	return &MockClientAPI_Search_Call{Call: _e.mock.On("Search", ctx, params)}
}

func (_c *MockClientAPI_Search_Call) Run(run func(ctx context.Context, params birdeye.SearchParams)) *MockClientAPI_Search_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 birdeye.SearchParams
		if args[1] != nil {
			arg1 = args[1].(birdeye.SearchParams)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockClientAPI_Search_Call) Return(searchResponse *birdeye.SearchResponse, err error) *MockClientAPI_Search_Call {
	_c.Call.Return(searchResponse, err)
	return _c
}

func (_c *MockClientAPI_Search_Call) RunAndReturn(run func(ctx context.Context, params birdeye.SearchParams) (*birdeye.SearchResponse, error)) *MockClientAPI_Search_Call {
	_c.Call.Return(run)
	return _c
}
