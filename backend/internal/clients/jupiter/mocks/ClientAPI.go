...
func (_mock *MockClientAPI) GetNewCoins(ctx context.Context, params *jupiter.NewCoinsParams) ([]*jupiter.NewTokenInfo, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *jupiter.NewCoinsParams) ([]*jupiter.NewTokenInfo, error)); ok {
		return returnFunc(ctx, params)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *jupiter.NewCoinsParams) []*jupiter.NewTokenInfo); ok {
...
func (_c *MockClientAPI_GetNewCoins_Call) Return(newTokenInfos []*jupiter.NewTokenInfo, err error) *MockClientAPI_GetNewCoins_Call {
	_c.Call.Return(newTokenInfos, err)
	return _c
}

func (_c *MockClientAPI_GetNewCoins_Call) RunAndReturn(run func(ctx context.Context, params *jupiter.NewCoinsParams) ([]*jupiter.NewTokenInfo, error)) *MockClientAPI_GetNewCoins_Call {
	_c.Call.Return(run)
	return _c
}
