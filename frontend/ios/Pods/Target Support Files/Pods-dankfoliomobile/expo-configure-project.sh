...
with_node \
  ...
  --target "/Users/nma/dev/dankfolio/frontend/ios/Pods/Target Support Files/Pods-dankfoliomobile/ExpoModulesProvider.swift" \
  --entitlement "/Users/nma/dev/dankfolio/frontend/ios/dankfoliomobile/dankfoliomobile.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-app-integrity" "expo-asset" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-eas-client" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-keep-awake" "expo-secure-store" "expo-splash-screen" "expo-updates"
