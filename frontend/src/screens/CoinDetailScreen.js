...
const CoinDetailScreen = ({ route, navigation }) => {
        ...
        // Get description for the coin
        const getCoinDescription = () => {
                const descriptions = {
                        SOL: "Solana is a high-performance blockchain supporting builders around the world creating crypto apps that scale. Solana is known for its fast transactions and high throughput.",
                        USDC: "USD Coin (USDC) is a digital stablecoin that is pegged to the United States dollar. USDC is managed by the Centre consortium, founded by Circle and Coinbase.",
                        USDT: "Tether (USDT) is a stablecoin pegged to the US dollar. Tether tokens are issued by Tether Limited and are designed to maintain a value of US$1.00.",
                        BTC: "Bitcoin is the first decentralized cryptocurrency. Bitcoin uses peer-to-peer technology to operate with no central authority or banks.",
                ...
                return descriptions[coin.symbol] || `${coin.name} (${coin.symbol}) is a cryptocurrency token running on the Solana blockchain.`;
        };
