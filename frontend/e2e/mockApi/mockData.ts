...
export const MOCK_TRENDING_COINS: ProtobufCoin[] = [
	...
	create(CoinSchema, {
		...
		logoUri: 'https://static.wikia.nocookie.net/dank_memer/images/e/e6/Site-logo.png/revision',
...
export const MOCK_NEW_COINS: ProtobufCoin[] = [
	...
	create(CoinSchema, {
		...
		resolvedIconUrl: 'https://coin-images.coingecko.com/coins/images/38112/large/Bull_Run_%281%29.png?1716536310',
		tags: ['defi', 'alpha', 'new'],
		price: 0.0025,
		price24hChangePercent: -5.2,
		marketcap: 2500000,
...
export const MOCK_TOP_GAINER_COINS: ProtobufCoin[] = [
	create(CoinSchema, {
		...
		logoUri: 'https://production-s3-djangomediabucket-j9zlzkkigf3m.s3.amazonaws.com/episodes/images/32932-157aee6d516dc2d9b639f0062e2c420a0b9d3b9c0bc7a2b741e02bf88c22b2b3.jpg',
	...
	create(CoinSchema, {
		...
		resolvedIconUrl: 'https://preview.redd.it/spacex-starship-meme-v0-4qo5qk890ula1.jpg?width=640&crop=smart&auto=webp&s=a34b70dadb0f2cbb88ee2a2929e6bf02c83672f6',
