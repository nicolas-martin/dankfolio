...
- **Account Creation & Login:**
  ...
  - Support Apple Sign-In, Google, and Facebook for authentication.

- **Wallet Management:**
  - Provide users with a wallet that currently supports Solana-based coins (with potential multi-chain support in the future).
  - Enable deposit and withdrawal of coins.
  - Include a section for displaying secret words and allow users to back up their wallet.
  - Provide pages for managing account information and security settings.

- **Funding Options:**
  - Allow users to add funds or crypto to their account via:
    - Apple Pay
    - Credit Card
    - Crypto transfers (e.g., Coinbase Wallet, MetaMask, Phantom Wallet)

### 4. Leaderboards and Additional User Features

- **Top Users Page:**
  - Display the top 100 users based on profit.
  - Provide a button to toggle the view between profit in the last 24 hours, 7 days, and 30 days on the same page.

- **User Settings & Support:**
  - Include separate pages for:
    - Account Information (with edit capabilities)
    - Wallet (for deposits and withdrawals)
    - Secret Words / Backup
    - Security Settings
    - Notifications
    - General Settings
    ...
    - FAQ
    - Terms of Service
    - Support Tickets (with the ability to create new tickets)
